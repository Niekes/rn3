...
export default {
    ...
    input: {
        ...
        deleteBtn: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"><path fill="currentColor" d="M9.191 21.64c-.812 0-1.539-.421-1.964-1.058-.22-.324-.36-.7-.395-1.11L5.887 8.09h12.11l-.946 11.383c-.04.41-.18.785-.395 1.109a2.382 2.382 0 01-1.965 1.059zM18.27 6.399c0-.554-.45-1.007-1.008-1.007H6.613A1.01 1.01 0 005.61 6.398V7.2h12.66zm-8.145-2.453c0-.445.367-.812.816-.816h1.996c.45 0 .813.367.813.816V4.5h.89v-.555c0-.937-.769-1.707-1.703-1.707h-1.996c-.937 0-1.707.77-1.707 1.707V4.5h.891zm0 0"/></svg>',
